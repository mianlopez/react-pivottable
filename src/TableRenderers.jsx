...
export default {
  Tabla: makeRenderer(),
  'Tabla Mapa de calor': makeRenderer({heatmapMode: 'full'}),
  'Tabla Mapa de calor columna': makeRenderer({heatmapMode: 'col'}),
  'Tabla Mapa de calor fila': makeRenderer({heatmapMode: 'row'}),
